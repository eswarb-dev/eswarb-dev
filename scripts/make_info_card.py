...
# ===========================================================================
HOST = "eswarb-dev"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Name", "Eswar B"),
    ("kv", "Role", "AI Engineer | Full Stack Dev"),
    ("kv", "Mobile", "React Native, Expo, Flutter"),
    ("kv", "Builds", "AI products, apps, automation"),
    ("kv", "Focus", "Real workflows, clean interfaces"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Code", "Python, JavaScript, Dart"),
    ("kv", "Frontend", "React, React Native, Expo"),
    ("kv", "Backend", "Node.js, Supabase, Postgres, SQLite"),
    ("kv", "AI / CV", "ML fundamentals, YOLO, TFLite, Gemini"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "VenueVerse: campus booking workflows"),
    ("bul", "HireWave: AI-assisted recruitment tools"),
    ("bul", "Hacksprint 2.0 finalist"),
    ("bul", "Graphic design intern; UI/UX exposure"),
]
